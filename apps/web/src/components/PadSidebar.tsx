...
const ITEMS: Item[] = [
  { id: 'notes', label: 'Notes', icon: <NotesIcon />, shortcut: '1' },
  { id: 'files', label: 'Files', icon: <FilesIcon />, shortcut: '2' },
  { id: 'members', label: 'People', icon: <PeopleIcon />, shortcut: '3' },
  { id: 'chat', label: 'Chat', icon: <ChatIcon />, shortcut: '4' },
  { id: 'terminal', label: 'Terminal', icon: <TerminalIcon />, shortcut: '5' },
  { id: 'whiteboard', label: 'Whiteboard', icon: <BoardIcon />, shortcut: '6' },
  { id: 'recordings', label: 'Recordings', icon: <RecordIcon />, shortcut: '7' },
];
